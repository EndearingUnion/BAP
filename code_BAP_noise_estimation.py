...
#reading the data
f = h5py.File("source_tls_only.h5", "r")
...
#This chunk code is based on the code from www.socsci.ru.nl/wilberth/python/noise.html by drs. W.C.P. van Ham and altered to fit our project
...
ASD_estimation = np.sqrt(Pxx_estimation)*channel_bandwidth(channel)*k_B #ASD in [W/√Hz]


plt.figure()
plt.loglog(f_welch, ASD_estimation, label="TLS noise estimation")
